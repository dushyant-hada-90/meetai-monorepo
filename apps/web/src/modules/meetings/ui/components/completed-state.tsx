...
import { BookOpenTextIcon, ClockFadingIcon, FileTextIcon, SparkleIcon, SparklesIcon } from "lucide-react"
                    ...
                    <div className="bg-white rounded-lg border">
                        <div className="px-4 py-5 gap-y-5 flex flex-col span-5">
                            ...
                            <div className="flex flex-wrap gap-x-2 gap-y-1 items-center">
                                ...
                                <p className="text-sm md:text-base">{data.startedAt ? format(data.startedAt, "PPP") : ""}</p>
                            </div>
